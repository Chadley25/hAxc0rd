    ...
    run: async (client, message, args) => {
        ...
        if (args[0] == "help" || !args[0]) {
            ...
            const helpEmbed = new Discord.MessageEmbed()
                ...
                .addField('Description', "Nslookup is a command-line tool used for querying a Domain Name System (DNS) to obtain domain name or IP address mapping, or other DNS records for a domain name.")
                .addField('Arguments', "None")
                .addField('Example', 'nslookup chadley25.github.io')
